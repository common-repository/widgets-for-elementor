...
use Wfe\Api\Callbacks\ManagerCallbacks;
use Wfe\Api\SettingsApi;
use Wfe\Base\BaseController;
use Wfe\Api\Callbacks\AdminCallbacks;
...
class AdminPages extends BaseController {
	...
	public function setPages() {
		$this->pages = array(
			array(
				'page_title' => 'Widgets For Elementor',
				'menu_title' => 'Widgets For Elementor',
