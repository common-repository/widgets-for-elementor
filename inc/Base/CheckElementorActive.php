...
class CheckElementorActive/* extends BaseController*/ {
	...
	public function wfe_is_failed_to_load() {
		...
		if ( wfe_is_elementor_active() ) {
			...
			$message        = __( '<strong>Widgets For Elementor</strong> requires Elementor plugin to be active. Please activate Elementor to continue.', 'wfe_elementor' );
			...
			$message        = sprintf( __( '<strong>Widgets For Elementor</strong> requires %1$s"Elementor"%2$s plugin to be installed and activated. Please install Elementor to continue.', 'wfe_elementor' ), '<strong>', '</strong>' );
