...
$plugin_data    = get_plugin_data( $filpath . 'widgets-for-elementor.php' );
...
<div id="pev-wrap">
    <div id="pev-desc-main">
        <h3 id="pev-title">Widgets For Elementor</h3>
        <p>Widgets For Elementor has module basis structure. You can easily activate/deactivate any widgets as your needs anytime. When you updated plugin, you can check this page and activate new
            modules.</p>
        <p>All Widgets Activate By Default, You Should Deactivate WIdgets Which One you like, You may deactivate/activate All Widgets By Clicking Enable/Disable Button.</p>
    </div>
                ...
                <div class="prime_welcome-feature">
                    ...
                    <div class="prime-grid-wrapper row">
                        <div class="col-md-6 prime-grid-item ">
                            <h4><span class="dashicons dashicons-images-alt2 prime_lefticon"></span>What is Widgets For Elementor Plugin?</h4>
                            <p>Widgets For Elementor is developed to extend Elementor to save your time in building websites. This plugin adds a number of elements to the
                        ...
                        <div class="col-md-6 prime-grid-item">
                            ...
                            <p>Infinity effects & variations usage comes with Widgets For Elementor in your way. You can apply your own customized shortcodes in anywhere with flexible
                                effects.</p>
                        </div>
                    </div>
                    <div class="prime-grid-wrapper">
                        <div class="col-md-6 prime-grid-item">
                            ...
                            <p>With the Widgets For Elementor, you are free to use the basic elements of Elementor with several advanced elements that it adds in the editor.</p>
                        </div>

                        <div class="col-md-6 ">
                            <h4><span class="dashicons dashicons-universal-access prime_lefticon"></span> We stand by you!</h4>
                            <p>With several video tutorials and a dedicated support team, we assure complete help and support whenever you need us. Go ahead and explore the Widgets For Elementor of Elementor Page Builder!</p>
                        </div>
                    </div>

                    <div class="prime-grid-wrapper">
                        <div class="col-lg-12 nopadding">
                            <iframe class="prime-iframe" src="https://codecans.com/tutorials/widgets-for-elementor/changelog.html" frameborder="0" width="100%" height="400px"></iframe>
                        </div>
                    </div>
